 ...
 * of critical operations; therefore invoking methods null {@link #readLine()}, {@link #readPassword()}, {@link #format format()},
 * {@link #printf printf()} as well as the read, format and write operations on
 * the objects returned by {@link #reader()} and {@link #writer()} may block in
...
public final class Console implements Flushable
{
	 ...
	 * on the returned object will not read in characters beyond the line bound
	 * for each invocation, even if the destination buffer has space for more
	 ...
	 *
	 * @throws IllegalFormatException If a format string contains an illegal
	 * syntax, a format specifier that is incompatible with the given arguments,
	 * insufficient arguments given the format string, or other illegal
	 * conditions. For specification of all possible formatting errors, see the
