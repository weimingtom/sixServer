/**
 * @author Liuxiaomeng
 * @datetime 2015年11月21日_下午2:22:20
 */
 ...
 * 内存占用情况
 * 
 * @author Liuxiaomeng //      MemUtils.memoryInfo();
 * @datetime 2015年11月21日_下午2:22:20
 */
public class MemUtils {
	
	private static final Logger	log	=  LoggerFactory.getLogger(MemUtils.class);
...
//		return (new StringBuilder("Free memory ")).append(freeMem).append(" Mb of ").append(totalMem).append(" Mb").toString();
//	}
}
